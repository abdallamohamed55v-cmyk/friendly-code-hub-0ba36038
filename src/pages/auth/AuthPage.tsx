...
import authSideVideo from "@/assets/auth-side-loading.mp4.asset.json";
...
const AuthPage = () => {
  ...
  if (isMobile && (step === "intro1" || step === "email" || step === "password")) {
    const mobileScreen: "intro" | "email" = step === "intro1" ? "intro" : "email";
    return (
      <>
        <SEOHead
  ...
  return (
    <>
      <SEOHead
        ...
        noindex
      />
      <div className="relative min-h-dvh w-full overflow-hidden bg-black text-foreground flex flex-col lg:flex-row">
