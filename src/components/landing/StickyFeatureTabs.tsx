...
const StickyFeatureTabs = () => {
  ...
  return (
    <section id="features" className="bg-black py-12 md:py-28 text-foreground overflow-hidden">
      <div className="mx-auto max-w-[1600px] px-5 md:px-12">
        ...
        >
          <h2
            ...
            className="uppercase tracking-tight text-foreground leading-[0.95] text-[8vw] md:text-7xl"
          >
            HOW MEGSY'S AI
            <br className="hidden md:inline" />{" "}
            <span className="md:hidden">CREATIVE SUITE WORKS</span>
            <span className="hidden md:inline">CREATIVE SUITE WORKS</span>
          </h2>
              ...
              {tabs.map((tab, i) => {
                ...
                return (
                  <motion.button
                    ...
                    className="relative flex w-full items-center gap-4 md:gap-5 rounded-ios-lg p-4 md:p-6 text-left transition-shadow md:ml-[var(--offset)]"
                  >
                    <span
                      style={{ fontFamily: '"Dela Gothic One", sans-serif' }}
