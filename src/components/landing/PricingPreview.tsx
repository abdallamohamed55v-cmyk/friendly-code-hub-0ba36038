...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { label: "Unlimited Videos", value: true },
      { label: "Unlimited Code Builder", value: true },
      { label: "Unlimited Slides & Docs", value: true },
      { label: "Unlimited Deep Research", value: true },
      { label: "Unlimited Megsy OS Agents", value: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Unlimited Everything", value: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Unlimited Team Seats", value: true },
