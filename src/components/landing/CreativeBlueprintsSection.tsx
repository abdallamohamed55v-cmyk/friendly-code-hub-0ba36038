    ...
    >
      ...
      <div className="space-y-[-1.5vw] md:space-y-[-1vw]">
        ...
        <motion.h2
          ...
          className="whitespace-nowrap font-display text-[18vw] font-black uppercase leading-[0.85] tracking-tighter text-foreground"
        >
          BUILT FOR <span className="inline-block align-middle text-purple-500">▶▶▶</span>
        </motion.h2>
        <motion.h2
          style={{ x: xLine3 }}
          className="whitespace-nowrap font-display text-[18vw] font-black uppercase leading-[0.85] tracking-tighter text-foreground"
        >
          <span className="inline-block align-middle text-purple-500">✿</span> CREATIVES
        </motion.h2>
      </div>
      ...
      >
        <p className="text-sm md:text-xl text-muted-foreground">
          Skip the trial and error. Blueprints are pre-designed templates that give you a structured
          starting point, saving time and ensuring your outputs stay consistent, polished, and
          on-brand.
        </p>
        <a
          href="#pricing"
