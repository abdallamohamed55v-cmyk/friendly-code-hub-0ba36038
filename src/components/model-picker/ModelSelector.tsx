...
const CHAT_MODELS: ModelOption[] = [
  { id: "qwen-max", name: "Megsy 3.9 Max", credits: "" },
  { id: "qwen-plus", name: "Megsy 3.9 Plus", credits: "" },
  { id: "qwen-turbo", name: "Megsy 3.9 Turbo", credits: "" },
  { id: "glm-4.6", name: "GLM 5.2", credits: "", badges: ["NEW"] },
  { id: "moonshot-kimi-k2-instruct", name: "Kimi K2.7", credits: "", badges: ["NEW"] },
];
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-xl text-xs font-medium transition-colors ${colorClass || "border-0 bg-transparent text-foreground/85 hover:bg-transparent hover:text-foreground"}`}
          style={colorClass ? undefined : { ...glassModelMenuTriggerStyle, background: "transparent", border: 0, boxShadow: "none" }}
        >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={`${glassModelMenu.panel} absolute bottom-full mb-2 right-0 z-50 w-56 max-w-[calc(100vw-2rem)]`}
            ...
            >
              {models.map((m) => (
                <button
                  ...
                  className={glassModelMenu.item(selectedModel.id === m.id, "gap-3 text-sm")}
                >
                  <span className="hidden md:inline-flex">
